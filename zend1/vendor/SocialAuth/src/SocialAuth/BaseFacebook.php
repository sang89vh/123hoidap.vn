	...
	*/
	...
	protected function throwAPIException($result) { 
		...
		switch ($e->getType()) { 
			...
			case 'OAuthException':  $this->error = 1; $this->errorLog($e->getMessage());  break;
				// OAuth 2.0 Draft 10 style
			case 'invalid_token': $this->error = 1; $this->errorLog($e->getMessage());  break;
				// REST server errors are just Exceptions
			case 'Exception': $this->error = 1;
