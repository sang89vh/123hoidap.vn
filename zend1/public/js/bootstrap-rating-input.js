(function ($) {
  ...
  $.fn.rating = function () {
    ...
    function _paintValue(ratingInput, value) {
      ...
      selectedStar.removeClass('glyphicon glyphglyphicon glyphicon-star-empty').addClass('glyphicon glyphicon-star');
      selectedStar.prevAll('i').removeClass('glyphicon glyphglyphicon glyphicon-star-empty').addClass('glyphicon glyphicon-star');
      selectedStar.nextAll('i').removeClass('glyphicon glyphicon-star').addClass('glyphicon glyphglyphicon glyphicon-star-empty');
    }

    // A private function to remove the selected rating
    function _clearValue(ratingInput) {
      var self = $(ratingInput);
      self.find('i').removeClass('glyphicon glyphicon-star').addClass('glyphicon glyphglyphicon glyphicon-star-empty');
    ...
    for (element = this.length - 1; element >= 0; element--) {
      ...
      for (i = min; i <= max; i++) {
        ...
        stars += ['<i class="glyphicon glyphglyphicon glyphicon-star-empty" data-value="', i, '"></i>'].join('');
      }
